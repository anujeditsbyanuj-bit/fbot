...
def download_thumb(thumb_url: str, thumb_path: str) -> bool:
    ...
    Sends a Referer header derived from the CDN hostname so hotlink-protected
    CDNs (e.g. YouPorn's ypncdn.com, SpankBang's pcdn.com) don't 403."""
    try:
        from urllib.parse import urlparse
        parsed = urlparse(thumb_url)
        # Map known CDN domains back to their parent site for Referer
        host = parsed.netloc.lower()
        _cdn_referers = {
            "ypncdn.com":      "https://www.youporn.com/",
            "pix-cdn77.ypncdn.com": "https://www.youporn.com/",
            "pcdn.com":        "https://spankbang.com/",
            "eidn.com":        "https://www.eporner.com/",
            "thumb.xhcdn.com": "https://xhamster.com/",
            "ic.xhcdn.com":    "https://xhamster.com/",
            "xvcdn.com":       "https://www.xvideos.com/",
        }
        referer = next(
            (ref for cdn, ref in _cdn_referers.items() if cdn in host),
